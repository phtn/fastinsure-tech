  ...
  return (
    <div
      className={cn(
        ...
        "border-primary bg-gradient-to-tr from-stone-300/40 via-zinc-300/40 to-slate-300/40",
        "dark:border-slate-300/60 dark:from-slate-200/20 dark:via-slate-200/40 dark:to-slate-200",
      )}
    >
      <Lines />
