...
export const Beta = () => (
  <div className="h-fit w-full overflow-auto pb-20 xl:h-screen xl:pb-0">
    <Header />
    <Columns />
  </div>
);
...
const Header = () => (
  <div className="font-inst flex h-[calc(100vh*0.125)] w-full items-center justify-center p-4 md:h-[calc(100vh*0.2)] lg:grid-cols-2 xl:h-[calc(100vh*0.2)] xl:p-12">
    <div className="flex h-full w-full flex-col items-start justify-start px-6 xl:px-12">
      <h2 className="text-3xl font-semibold tracking-tight md:text-2xl">
        Partner Login
      </h2>
...
const Columns = () => (
  <div className="grid h-[calc(100vh*0.875)] w-full grid-cols-1 lg:grid-cols-5 xl:h-[calc(100vh*0.8)]">
    <div className="flex h-full w-full items-start justify-center lg:col-span-2">
      <AuthLobby />
    </div>
    <div className="h-full w-full px-6 lg:col-span-3 xl:pr-20">
      <div className="font-inst pb-2 text-3xl font-medium opacity-60 xl:pb-6">
        Remote Monitoring
      </div>
      <Chart />
    </div>
...
function Chart() {
  ...
  return (
    <Card className="shadow-xl shadow-slate-300/50">
