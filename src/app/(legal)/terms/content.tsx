...
export const TermsOfUse = () => {
  return (
    <Content
      ...
      sections={sections}
      footer={{ label: "privacy policy", href: `/privacy` }}
      title={"terms and conditions"}
    />
  );
};

const important_message = `Welcome to FastInsure Technologies ("we," "our," "us"). By accessing or using our web application ("App") or any of our services, you agree to comply with and be bound by these Terms of Use.
