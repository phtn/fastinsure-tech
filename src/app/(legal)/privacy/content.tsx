...
export const PrivacyPolicy = () => {
  return (
    <Content
      company={"FastInsure Technologies"}
      important_message={important_message}
      sections={sections}
      footer={{ label: "terms of use", href: `/terms` }}
      title={"privacy policy"}
    />
  );
};

const important_message = `FastInsure Technologies ("we," "our," "us") is committed to protecting your
...
const sections: Section[] = [
  ...
  },
  {
    ...
    id: "contact-us",
    title: "Contact Us",
    content: `If you have any questions about this Privacy Policy or our data practices, please contact our Data Protection Officer at fastinsuretech@gmail.com or by mail at: Office of the Data Protection Officer, 5F Crissant Plaza Bldg, Quezon City, 1119 Metro Manila, Philippines.`,
  },
];
