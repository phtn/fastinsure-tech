...
export const Underlay = ({ children }: PropsWithChildren) => (
  <div className="dark:bg-background/80_ h-screen justify-between gap-10 bg-void dark:bg-gradient-to-tr dark:from-darkarmy/60 dark:via-army/50 dark:to-fade/40 dark:backdrop-blur-xl">
    {children}
  </div>
);
